...
I need assistance with my order #[Order Number].
...
I need assistance with a payment-related matter.
...
I would like to request the following documentation:
...
[Your Name]`
  ...
  const composeEmail = (template: EmailTemplate) => {
    const mailtoLink = `mailto:meetus@mersate.com?subject=${encodeURIComponent(template.subject)}&body=${encodeURIComponent(template.body)}`
